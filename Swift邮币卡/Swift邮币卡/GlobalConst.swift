...
let GLOBAL_RED = UIColor (colorLiteralRed: 241/255, green: 77/255, blue: 67/255, alpha: 1);

let GLOBAL_BLUE = UIColor (colorLiteralRed: 58/255, green: 155/255, blue: 229/255, alpha: 1);
